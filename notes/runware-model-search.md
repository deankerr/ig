...
url: https://runware.ai/docs/utilities/model-search
description: Search and discover AI models available in the Runware platform. Filter and find the perfect model for your image generation needs.
relatedDocs:
  - https://runware.ai/docs/image-inference/models
  - https://runware.ai/docs/image-inference/model-upload
  - https://runware.ai/docs/image-inference/api-reference
---
...
### [taskType](https://runware.ai/docs/utilities/model-search#request-tasktype)
...
### [taskUUID](https://runware.ai/docs/utilities/model-search#request-taskuuid)
...
### [search](https://runware.ai/docs/utilities/model-search#request-search)
...
### [tags](https://runware.ai/docs/utilities/model-search#request-tags)
...
### [category](https://runware.ai/docs/utilities/model-search#request-category)
...
### [type](https://runware.ai/docs/utilities/model-search#request-type)
...
### [architecture](https://runware.ai/docs/utilities/model-search#request-architecture)
...
### [conditioning](https://runware.ai/docs/utilities/model-search#request-conditioning)
...
### [visibility](https://runware.ai/docs/utilities/model-search#request-visibility)
...
### [limit](https://runware.ai/docs/utilities/model-search#request-limit)
...
Maximum number of items to return in a single request. Used for pagination in combination with [offset](https://runware.ai/docs/utilities/model-search#request-offset).

### [offset](https://runware.ai/docs/utilities/model-search#request-offset)

- **Type**: `integer`
- **Min**: 0
- **Default**: 0

Number of items to skip in the result set. Used for pagination in combination with [limit](https://runware.ai/docs/utilities/model-search#request-limit).
...
### [taskType](https://runware.ai/docs/utilities/model-search#response-tasktype)
...
### [taskUUID](https://runware.ai/docs/utilities/model-search#response-taskuuid)
...
### [totalResults](https://runware.ai/docs/utilities/model-search#response-totalresults)
...
### [results](https://runware.ai/docs/utilities/model-search#response-results)
...
### [air](https://runware.ai/docs/utilities/model-search#response-air)
...
### [name](https://runware.ai/docs/utilities/model-search#response-name)

- **Type**: `string`

The display name of the model.

### [version](https://runware.ai/docs/utilities/model-search#response-version)

- **Type**: `string`

The version label of the model.

### [category](https://runware.ai/docs/utilities/model-search#response-category)

- **Type**: `string`

The category of the model. See [possible values](#request-category).

### [architecture](https://runware.ai/docs/utilities/model-search#response-architecture)

- **Type**: `string`

The architecture of the model. See [possible values](#request-architecture).

### [type](https://runware.ai/docs/utilities/model-search#response-type)
...
### [tags](https://runware.ai/docs/utilities/model-search#response-tags)

- **Type**: `string[]`

Array of tags associated with the model.

### [heroImage](https://runware.ai/docs/utilities/model-search#response-heroimage)

- **Type**: `string`

URL of the model's preview image.

### [private](https://runware.ai/docs/utilities/model-search#response-private)

- **Type**: `boolean`

Indicates whether this is a private model (`true`) or a public one (`false`).

### [comment](https://runware.ai/docs/utilities/model-search#response-comment)

- **Type**: `string`

Additional notes or comments about the model.

### [defaultWidth](https://runware.ai/docs/utilities/model-search#response-defaultwidth)
...
### [defaultHeight](https://runware.ai/docs/utilities/model-search#response-defaultheight)
...
### [defaultSteps](https://runware.ai/docs/utilities/model-search#response-defaultsteps)
...
### [defaultScheduler](https://runware.ai/docs/utilities/model-search#response-defaultscheduler)
...
### [defaultCFG](https://runware.ai/docs/utilities/model-search#response-defaultcfg)
...
### [defaultStrength](https://runware.ai/docs/utilities/model-search#response-defaultstrength)
...
### [positiveTriggerWords](https://runware.ai/docs/utilities/model-search#response-positivetriggerwords)
...
### [conditioning](https://runware.ai/docs/utilities/model-search#response-conditioning)
