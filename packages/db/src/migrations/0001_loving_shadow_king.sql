-- Drop tags table (references artifacts), recreate artifacts without NOT NULL on generation_id, restore tags.
-- D1 does not honor PRAGMA foreign_keys=OFF across statement-breakpoint boundaries.
